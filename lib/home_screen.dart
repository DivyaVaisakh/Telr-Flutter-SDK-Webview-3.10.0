...
getCards();
  ...
  void getCards()async{
    ...
    if(SavedCardListResponse['Status'] == 'Success')
    {
      ...
      String url = 'https://secure.telr.com/jssdk/v2/token_frame.html?sdk=ios&store_id=${GlobalUtils.storeId}&currency=aed&test_mode=${GlobalUtils.testmode}&saved_cards=${encodeQueryString(nameString.toString())}';
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        //         GlobalUtils.token=_token;
                        //         print('Response token1 = ${GlobalUtils.token}');
                        //         setState(() {
                        //           _apiLoaded = false;
                        //         });
                        //         getCards();
...
//new code
                                builder.element('paymethod', nest: (){
                                  ...
                                  builder.element('cardtoken', nest: (){
                                  //  print('Response token11 = $_token');
                                    builder.text(_token); // token value should be there
                                  });
                                });
                              });
